...
prompt_version        VARCHAR         version of clip detection prompt used (e.g. "v1")
...
- The active version is set via environment variable: `CLIP_PROMPT_VERSION=v1`.
